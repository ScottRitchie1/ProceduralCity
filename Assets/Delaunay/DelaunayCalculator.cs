	...
	public class DelaunayCalculator {
		...
		void RunBowyerWatson() {
			...
			for (int i = 0; i < verts.Count; i++) {
                ...
                //if (i == 6 || i == 5)
                //{
                //    List<Vector2> tri1 = new List<Vector2>();
                //    tri1.Add(verts[nt0.P0]);
                //    tri1.Add(verts[nt0.P1]);
                //    tri1.Add(verts[nt0.P2]);
                //    CityTest.LineRenderPoly(tri1);
                //
                //    List<Vector2> tri2 = new List<Vector2>();
                //    tri2.Add(verts[nt1.P0]);
                //    tri2.Add(verts[nt1.P1]);
                //    tri2.Add(verts[nt1.P2]);
                //    CityTest.LineRenderPoly(tri2);
                //
                //    List<Vector2> tri3 = new List<Vector2>();
                //    tri3.Add(verts[nt2.P0]);
                //    tri3.Add(verts[nt2.P1]);
                //    tri3.Add(verts[nt2.P2]);
                //    CityTest.LineRenderPoly(tri3);
                //
                //}
            }
		}
